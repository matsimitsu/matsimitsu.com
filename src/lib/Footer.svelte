  ...
  <div class="container mx-auto px-4">
    <div class="sm:flex sm:flex-wrap sm:-mx-4 md:py-4 px-4">
      ...
      <div class="px-4 mt-4 sm:w-1/3 xl:w-1/6 sm:mx-auto sm:text-center xl:text-left xl:mt-0 xl:ml-auto">
        <h5 class="text-xl font-bold mb-6 ">Credits</h5>
				<ul class="list-none footer-links">
          <li class="mb-2">
            Icons by <a class="hover:text-blue-500" href="https://fontawesome.com">FontAwesome</a>
          </li>
          <li class="mb-2">
            Maps from <a class="hover:text-blue-500" href="https://github.com/topojson/world-atlas">Topojson</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="flex justify-between items-center mt-6 pt-6 sm:mt-12 sm:pt-12 border-t dark:border-gray-700 text-gray-400">
      <div class="px-4">
				...
				and <a class="text-blue-400 hover:text-blue-500" href="https://svelte.dev">Svelte</a>
      </div>
      <div class="px-4 text-center mx-auto">
				&copy {new Date().getFullYear() } Matsimitsu
      </div>
      <div class="flex justify-end px-4">
				<a href="https://twitter.com/matsimitsu" class="hover:text-blue-500">
				...
				<a href="https://github.com/matsimitsu" class="hover:text-blue-500 ml-4">
				...
				<a href="mailto:hello@matsimitsu.nl" class="hover:text-blue-500 ml-4">
